...
<p>Reference section for the <a href="https://github.com/shesselink81">shesselink81</a> GitHub account: 9 repositories (4 public, 5 private), spanning homelab infrastructure, Home Assistant, and this UniFi dashboard itself.</p>
...
<h3 class="wp-block-heading">Primary Language</h3>
...
<h3 class="wp-block-heading">Cross-Repo Technology Patterns</h3>
...
<p><em>GitHub section compiled via the GitHub MCP server; repos with no description had one inferred from their README/file tree.</em></p>
`
