...
import HomeLinksTab from '@/components/HomeLinksTab'
import CloudAppsTab from '@/components/CloudAppsTab'
...
const TABS = ['home', 'overview', 'topology', 'docker'] as const
type Tab = (typeof TABS)[number]
const TAB_LABEL: Record<Tab, string> = {
  home: 'Home',
  overview: 'Network Monitor',
  topology: 'Network Topology',
  docker: 'Platforms Monitor',
}
